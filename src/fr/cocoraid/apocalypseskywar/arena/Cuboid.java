...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
	 ...
	 */
	public Cuboid(Point l1, Point l2) {
		worldName = "world";
		x1 = Math.min((int) l1.x, (int)l2.x);
		y1 = Math.min((int) l1.y,(int) l2.y);
		z1 = Math.min((int) l1.z,(int) l2.z);
		x2 = Math.max((int) l1.x,(int) l2.x);
		y2 = Math.max((int) l1.y,(int) l2.y);
		z2 = Math.max((int) l1.z,(int) l2.z);
	}
